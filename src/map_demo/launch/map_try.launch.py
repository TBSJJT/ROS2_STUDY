...
def generate_launch_description():
    ...
    # Safety enabled:
    #   Nav2/teleop -> /cmd_vel -> lidar_safety -> /cmd_vel_safe -> bridge
    # Safety disabled:
    #   Nav2/teleop -> /cmd_vel -> bridge
        ...
        parameters=[
            bridge_config,
            {
                ...
                "cmd_vel_topic": ParameterValue(
                    bridge_cmd_topic, value_type=str
                ),
            },
        ],
    )
        ...
        parameters=[
            {
                "front_angle_deg": ParameterValue(
                    lidar_angle, value_type=float
                ),
                "stop_distance": ParameterValue(
                    lidar_stop_distance, value_type=float
                ),
            }
        ],
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("N10lidar_angle", default_value="30.0"),
        # Unit is metres. The old value "30" meant 30 metres.
        DeclareLaunchArgument("N10lidar_stop_dis", default_value="0.30"),
        stm32_bridge,
        lidar_safety,
        lidar_launch,
    ])
